export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'kao-wool',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Kao Wool',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'kao-wool.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://kao-wool.com',
